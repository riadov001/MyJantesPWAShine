...
import { Loader2, Mail, Plus, X, Mic, Sparkles } from "lucide-react";
...
export function SendEmailDialog({
  ...
  const handleAiGenerate = async () => {
    ...
    try {
      const res = await apiRequest("POST", "/api/admin/ai/email-draft", {
        type,
        documentNumber,
        amount,
        clientName,
      ...
      toast({ title: "Email généré par IA", description: "Sujet et message remplis automatiquement. Vous pouvez les modifier." });
    } catch {
      toast({ title: "Erreur IA", description: "Impossible de générer l'email. Réessayez.", variant: "destructive" });
    } finally {
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1">
                <Button
                  ...
                  data-testid="button-ai-generate-email"
                >
