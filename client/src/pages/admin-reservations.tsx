...
export default function AdminReservations() {
  ...
  const handleCreateReservation = async () => {
    if (estimatedEndDate && scheduledDate && new Date(estimatedEndDate) <= new Date(scheduledDate)) {
      toast({ title: "Erreur", description: "La date de fin estimée doit être postérieure à la date de début", variant: "destructive" });
      return;
    }
  ...
  const handleEditReservation = () => {
    ...
    if (estimatedEndDate && new Date(estimatedEndDate) <= new Date(scheduledDate)) {
      toast({ title: "Erreur", description: "La date de fin estimée doit être postérieure à la date de début", variant: "destructive" });
      return;
    }
